                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr v-for="client in clients.data" :key="client.id">
                      <td>{{client.name}}</td>
                      <td>
                        <img class="img-fluid mb-3" :src="'./images/clients/'+client.photo" style="width:70px;" alt=" Avatar">
                      </td>
                      <td>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" v-show="!editmode" id="homeModalLabel">Add Client Details</h5>
                        <h5 class="modal-title" v-show="editmode" id="homeModalLabel">Update Client Info</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form @submit.prevent = "editmode ? updateClinic() :createClinic()">
                    <div class="modal-body">
                        <div class="form-group">
                            <input v-model="form.name" type="text" name="name" placeholder="Client name"
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="file" v-show="editmode" accept="image/*" @change="updateClinicPic"  class="form-input"/>
                            </div>
                        </div>
                    </div>
...
<script>
    export default {
        ...
        created() {
            ...
            //setInterval(() => this.loadClientInfo(), 3000);
            Fire.$on('AfterCreate', () =>{
                this.loadClientInfo();
            });
        }
