...
class TeamLeaderController extends Controller
{
    ...
    {
        $teams = TeamLeader::latest()->paginate(5);
    ...
    {
        $teams = TeamLeader::findOrFail($id);
